<template>
	<view class="collectcoin" :style="{width:windowWidth+'px',height:windowHeight+'px'}">
		...
		<view class="num">
			...
			<view class="num_right">
				<view class="num_right_left">
					...
					<span v-else-if="type === 1">X币</span>
					<image v-if="type === 0" src="../../static/img/home/USDT.png"></image>
					<image v-else-if="type === 1" src="../../static/img/team/v.png"></image>
				</view>
				<view class="address_right_center"><span></span></view>
		...
		<view class="available" v-if="type === 0">可用 {{all}} USDT</view>
		<view class="available" v-else-if="type === 1">可用 {{all}} X币</view>
		...
		<view class="service">
			...
			<view class="service_rights">
				...
				<span v-else-if="type === 1">{{dz}}X币</span>
				<image v-if="type === 0" src="../../static/img/home/USDT.png"></image>
				<image v-else-if="type === 1" src="../../static/img/team/v.png"></image>
			</view>
		</view>
