<template>
	<view class="collectcoin" :style="{width:windowWidth+'px',height:windowHeight+'px'}">
		...
		<view class="num">
			...
			<view class="num_right">
				<view class="num_right_left">
					...
					<image v-else-if="thisType === 1" src="../../static/img/logo/XEV.png"></image>
				</view>
				<view class="address_right_center"><span></span></view>
		...
		<view class="available" v-if="thisType === 0">{{i18n.Usable}} {{all}} USDT</view>
		<view class="available" v-else-if="thisType === 1">{{i18n.Usable}} {{all}} {{i18n.XCoin}}</view>
		...
		<view class="service">
			...
			<view class="service_right">
				...
				<span v-else-if="thisType === 1">{{i18n.XCoin}}</span>
				<image v-if="thisType === 0" src="../../static/img/home/USDT.png"></image>
				<image v-else-if="thisType === 1" src="../../static/img/logo/XEV.png"></image>
			</view>
		</view>
		...
		<view class="service">
			...
			<view class="service_rights">
				...
				<span v-else-if="thisType === 1">{{dz}}{{i18n.XCoin}}</span>
				<image v-if="thisType === 0" src="../../static/img/home/USDT.png"></image>
				<image v-else-if="thisType === 1" src="../../static/img/logo/XEV.png"></image>
			</view>
		</view>
