<template>
	<view class="team" :style="{width:windowWidth+'px',height:(windowHeight)+'px'}">
		...
		<view class="yqs" @click="toClassAList">
			<view class="yq_box">
				<view class="yq_box_left">
					...
					<span>{{$t('message').mine.MyTeam.InviteNumber}}</span>
				</view>
		...
		<view class="yj">
			<view class="yj_box">{{$t('message').mine.MyTeam.InviteNumber}}</view>
		</view>
		<view class="title">
			<view>{{$t('message').mine.MyTeam.Username}}</view>
			<view>{{$t('message').mine.MyTeam.Phone}}</view>
			<view>{{$t('message').mine.MyTeam.ContractSum}}</view>
			<view>{{$t('message').mine.MyTeam.Level}}</view>
			<view>{{$t('message').mine.MyTeam.State}}</view>
		</view>
