<template>
	<view class="addressmask" :style="{width:windowWidth+'px',height:windowHeight+'px'}">
		<view class="box">
			...
			<view class="bor"></view>
			<view class="box_op">
				<view class="box_op_left" style="color: #2C2C2C;">{{i18n.Financial}}</view>
			...
			<scroll-view scroll-y="true" style="width: 100%;height: 50vh;" @scrolltolower="scrolltolower">
				<view v-if="allList.length === 0" class="tips">{{i18n.NoRecord}}</view>
