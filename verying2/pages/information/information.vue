		...
		<scroll-view scroll-y="true" class="scroll-Y" :style="{width:windowWidth+'px',height:(windowHeight-50-top-50)+'px'}">
			<view class="information_box" style="color: #0CF2FF!important;">
				...
				<view class="information_box_operation" style="color: #0CF2FF!important;">
					<view class="information_box_operation_item" @click="coinCharging">{{i18n.Recharge}}</view>
					<view class="information_box_operation_item" @click="collectCoin">{{i18n.Extract}}</view>
					<view class="information_box_operation_item" @click="toTransfer">{{i18n.Exchange}}</view>
				</view>
			</view>
	...
	export default {
		data() {
			return {
				...
				list: [this.$t('message').mine.information.Assets, this.$t('message').mine.information.Dynamic, this.$t('message').mine.information.Points],
				active: 0,
				maskShow: false,
				allList: {
					...
					"assets_list": [{
						...
						"name": this.$t('message').mine.information.XCoin,
						"use_num": "0.00",
						"foeeze": "0.00",
						"repeat": "0.00",
						"price": "0.00"
						...
						"icon": "http://www.oszgs.top/Public/img/xev.png",
						"name": this.$t('message').mine.information.FreezePurse,
						"use_num": "0.00",
						"foeeze": "0.00",
						"repeat": "0.00",
						"price": "0.00"
						...
						"icon": "http://www.oszgs.top/Public/img/xev.png",
						"name": this.$t('message').mine.information.Points,
						"use_num": "0.00",
						"foeeze": "0.00",
						"repeat": "0.00",
						"price": "0.00"
