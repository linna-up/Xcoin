		...
		data() {
			return {
				...
				list: [{
						...
						text: this.$t('message').mine.RealName.Certification,
						jump: "../../../../Real/Real"
					},
					{
						img: "../../../../../static/img/my/gg.png",
						text: this.$t('message').mine.SystemNotice.SystemNotice,
						jump: "../../../../notice/notice"
					},
					{
					...
					},
					{
						...
						text: this.$t('message').mine.MyTeam.MyTeam,
						jump: '../../../../MyTeam/MyTeam'
					},
					/* {
					...
					}, */
					{
						...
						text: this.$t('message').mine.TradeOrder.TradeOrder,
						jump:"../../../../OrderList/OrderList"
					},
					{
						img: "../../../../../static/img/my/fk.png",
						text: this.$t('message').mine.ProblemFeedback.ProblemFeedback,
						jump: "../../../../Problem/Problem"
					},
					{
						img: "../../../../../static/img/my/node.png",
						text: this.$t('message').mine.ServiceNode.ServiceNode,
						jump: "../../../../NodeRules/NodeRules"
					},
					{
						img: "../../../../../static/img/my/sz.png",
						text: this.$t('message').mine.SetFocus.SetFocus,
						jump: "../../../../SetUp/SetUp"
					},
				]
			}
			...
			super_node(newVal) {
				if(newVal === "1" ||newVal === "2" || newVal === "3") {
					this.list.splice(7,0,{
						...
						text: this.$t('message').mine.SuperNode.SuperNode,
