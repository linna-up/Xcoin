<template>
	<view class="contractualing" :style="{width:windowWidth+'px',height:(windowHeight)+'px'}">
		<view class="notice_title" :style="{paddingTop:top+'px'}">
			...
			{{$t('message').mine.InvestmentRecord.Earnings}}
		</view>
		<Record></Record>
...
<script>
	...
	import Record from './child/InvestmentRecordItem.vue'
	import Records from './child/InvestmentRecordItems.vue'
	export default {
		data() {
			return {
