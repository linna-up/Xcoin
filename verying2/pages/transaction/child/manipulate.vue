<template>
	<view class="manipulate">
		<view class="manipulate_item buy_bg" @click="itemClick(0)" :class="{buy:activeIndex===0}">{{$t('message').transaction.Buy}}</view>
		<view class="manipulate_item sell_bg" @click="itemClick(1)" :class="{sell:activeIndex===1}">{{$t('message').transaction.Sell}}</view>
