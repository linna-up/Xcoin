	...
	export default {
		...
		data() {
			return {
				...
				list: [
					this.$t('message').OrderList.All,
					this.$t('message').OrderList.TradingIn,
					this.$t('message').OrderList.Completed,
					this.$t('message').OrderList.Cancelled],
				activeIndex: 0,
				AllList:[],
				ListIteming:[],
				FinBox:[],
				...
				upOption: {
					...
					empty: {
						tip: this.$t('message').OrderList.Nodata
					}
				},
				allId:0,
				ingId:0,
